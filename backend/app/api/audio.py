...
async def voice_intake_case(
    ...
    try:
        ...
        received_report_names, report_text = await extract_uploaded_reports(reports)
        stored_reports = []
        ...
        try:
            ...
            report_list = stored_reports or received_report_names or json.loads(report_names)
        ...
        spoken_text = await transcribe_audio(file) if file else ""
